...
import busybar_tools.downloads as downloads
...
def test_file_download_sends_custom_user_agent_and_writes_file(monkeypatch, tmp_path):
    ...
    path = downloads.download_file("https://example/bundle.tgz", "bundle.tgz", str(tmp_path), progress=True)
